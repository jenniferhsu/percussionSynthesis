...
ex = 'filteredNoise';%raisedCosine

%audioSaveDir = 'audioExamples/marimba/commutedSynth/process/';
if strcmp(ex, 'raisedCosine')
    audioSaveDir = 'audioExamples/marimba/commutedSynth/';
elseif strcmp(ex, 'filteredNoise')
    audioSaveDir = 'audioExamples/marimba/commutedSynth/filteredNoise/';
end
...
resIRWav = '../proofOfConcept/resonatorIRs/CarpenterCenter.wav';
