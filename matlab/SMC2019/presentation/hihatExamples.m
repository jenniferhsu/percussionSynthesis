...
% save audio
if saveAudio
    audiowrite([audioDir 'hsu_hihat_traditionalMS' '.wav'], ...
                scaleForSavingAudio(real(circularPlate_s)), fs);
    audiowrite([audioDir 'hsu_hihat_loopbackFM' '.wav'], ...
                scaleForSavingAudio(real(circularPlate_zc)), fs);
    audiowrite([audioDir 'hsu_hihat_traditionalMSCommutedSynthesis' '.wav'], ...
                scaleForSavingAudio(real(circularPlate_s_CS)), fs);
    audiowrite([audioDir 'hsu_hihat_loopbackFMCommutedSynthesis' '.wav'], ...
                scaleForSavingAudio(real(circularPlate_zc_CS)), fs);
    audiowrite([audioDir 'hsu_hihat_traditionalMSTimeVaryingAPFCommutedSynthesis' '.wav'], ...
                scaleForSavingAudio(real(yCircularPlate_s_CS)), fs);
    audiowrite([audioDir 'hsu_hihat_loopbackFMTimeVaryingAPFCommutedSynthesis' '.wav'], ...
