...
if strcmp('marimba', synthExample) == 1
    yLBFMWav = 'audioExamples/marimba/V2/loopbackFM.wav';
...
if strcmp('tom tom', synthExample) == 1
    yLBFMWav = 'audioExamples/tomtom/V2/loopbackFM.wav';
    yMSWav = 'audioExamples/tomtom/V2/modalSynthesis.wav';
    yMSPGWav = 'audioExamples/tomtom/V2/modalSynthesisPitchGlide.wav';
    resIRWav = '../proofOfConcept/resonatorIRs/taiko/taiko2cut.wav';
end

% Circular plate example
if strcmp('circular plate', synthExample) == 1
    yLBFMWav = 'audioExamples/circularPlate/V2/loopbackFM.wav';
    yMSWav = 'audioExamples/circularPlate/V2/modalSynthesis.wav';
    yMSPGWav = 'audioExamples/circularPlate/V2/modalSynthesisPitchGlide.wav';
    resIRWav = 'resonatorIRs/CarpenterCenter.wav';
end

% Wood block
if strcmp('wood block', synthExample) == 1
    yLBFMWav = 'audioExamples/woodBlock/V2/loopbackFM.wav';
    yMSWav = 'audioExamples/woodBlock/V2/modalSynthesis.wav';
    yMSPGWav = 'audioExamples/woodBlock/V2/modalSynthesisPitchGlide.wav';
...
%% generate raised cosine excitation (full window)
...
% modal synthesis with pitch glide
yMSPG_RC = percSynth(dexcitations(:,1), yMSPGWav, resIRWav);
yMSPG_RC = yMS_RC(1:N);

yMSPG_NB = percSynth(dexcitations(:,2), yMSPGWav, resIRWav);
yMSPG_NB = yMS_NB(1:N);
...
%% write audio
audioOutDir = 'audioExamples/synthesisExamples/V2/';
...
if strcmp('marimba', synthExample) || ...
    ...
    audiowrite([audioOutDir synthExample '_MSPG_RC.wav'], scaleForSavingAudio(yMSPG_RC), fs);
...
if strcmp('wood block', synthExample) || ...
    ...
    audiowrite([audioOutDir synthExample '_MSPG_NB.wav'], scaleForSavingAudio(yMSPG_NB), fs);
